...
<div class= "grid">
	<div class="title"><h1>Joffrey Ballet Performances</h1></div>
	<div class="content"> 
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
					<div class="page-header clearfix">
						<a href="performancecreate.php" class="btn btn-success pull-right">Add New Performance</a>
					</div>
					<?php
					...
					$sql = "SELECT  re.re_id as re_id,
									...
									where re.is_performance = 1";
					if($result = mysqli_query($conn, $sql)){
						if(mysqli_num_rows($result) > 0){
							echo "<table class='table table-bordered table-striped'>";
								echo "<thead>";
									echo "<tr>";
										echo "<th>Rehearsal ID</th>";
										echo "<th>Building</th>";
										echo "<th>Room</th>";
								...
								while($row = mysqli_fetch_array($result)){
									echo "<tr>";
										...
										echo "<td>";
											...
											echo "<a href='performanceupdate.php?re_id=". $row['re_id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
											echo "<a href='performancedelete.php?re_id=". $row['re_id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
										echo "</td>";
									echo "</tr>";
								}
								echo "</tbody>";                            
